		...
		<div class="top-nav">
			<span class="menu"><img src="images/menu.png" alt=""> </span>
				<ul>
						...
						<li><a href="showTypeNewsAction.action?status=1&type=生活" class="hvr-bounce-to-top">生活</a></li>
					</ul>
					<!--script-->
				<script>
...
<div class="content">
		<div class="style">
	<form action="loginAction" method="post" name="formLogin" class="basic-grey">
    	<div class="styleFont">邮箱：</div>
        <div class="styleForm"><input type="email" name="u_email"  /></div>
    	<div class="styleFont">密码：</div>
        <div class="styleForm"><input type="password" name="u_password"  /></div>     	
	    <div class="bu"><input type="submit" class="button" value="登陆" /></div>
	    <div class="bu"><input type="button" onclick="javascript:window.location.href='register.jsp';" class="button" value="注册" /></div> 
